...
import { CONTACTS, type Contact } from "../../fake-db";
...
export const onGet: RequestHandler<ContactForm> = async (ctx) => {
  return {
    contact: CONTACTS.filter((contact) => contact.id === ctx.params.contactId)[0],
    errors: {},
  };
};
          ...
          <form method="post">
            ...
            <div class="contact">
              ...
              <div class="row">
                ...
                {errors.name && <span class="errors">{errors.name}</span>}
              </div>
              <div class="row">
                <img
                  class="icon"
